...
const singleTransactionSchema = z.object({
    ...
    shipViaId: z.string().optional(),
    shippingCost: z.number().optional(),
    shippingBillId: z.string().optional(),
    shippingInvoiceLineId: z.string().optional(),
    outboundCarrierCost: z.number().optional(),
    outboundShippingBillId: z.string().optional(),
