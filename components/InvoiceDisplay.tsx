                ...
                <div className="p-16 flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-12 bg-slate-50 border-y-2 border-slate-200 py-8 px-10 mb-12">
                        <div>
                            ...
                            <p className="text-lg font-black text-slate-900 italic">{invoice.date}</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Due Date</p>
                            <p className={`text-lg font-black italic ${invoice.status === 'PAID' ? 'text-green-600' : 'text-red-600'}`}>
                                {invoice.dueDate || 'N/A'}
                            </p>
                        </div>
                        <div className="text-right">
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Invoice No.</p>
                            <p className="text-lg font-black text-slate-900 font-mono tracking-tighter">#{invoice.refNo}</p>
                        </div>
                    </div>
                        ...
                        <table className="w-full mb-12">
                            <thead>
                                <tr className="border-b-4 border-slate-900">
                                    <th className="text-left py-4 text-[11px] font-black uppercase tracking-widest text-slate-400">Item / Service</th>
                    ...
                    <div className="mt-auto border-t-8 border-slate-900 pt-12">
                        <div className="flex justify-between items-center bg-slate-100 p-8 rounded shadow-inner relative overflow-hidden">
                            ...
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-1">Total Invoice Amount</p>
                        ...
                        {invoice.memo && (
                            <div className="mt-8 border-l-4 border-slate-200 pl-6">
                                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Customer Memo</p>
                                <p className="text-sm text-slate-600 font-medium italic leading-relaxed">{invoice.memo}</p>
                            </div>
                        )}
                    </div>
                </div>
